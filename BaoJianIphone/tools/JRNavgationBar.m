...
- (id)initWithFrame:(CGRect)frame Option:(JRNAVGATIONTYPE)type{
    ...
    if (self) {
        ...
        titleLabel.font = UIFontHiraginoSansGBW6(17);
        ...
        homebtn.frame = CGRectMake(self.frame.size.width-44, IOS7?30:10, 44, 25);
        homebtn.center = CGPointMake(homebtn.center.x, (IOS7?20:0)+44/2);
        homebtn.titleLabel.font = [UIFont boldSystemFontOfSize:14];
